...
export const FloatingConsultButton = ({
  ...
  popupBadgeText = "Free",
  ctaButtonText = "Schedule on Google Calendar",
  ctaButtonAction = () => window.open("https://calendar.google.com/calendar/render?action=TEMPLATE&add=gianaibo.dev@gmail.com", "_blank"),
